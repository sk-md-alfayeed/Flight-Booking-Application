...
public class RabbitMQConfig {
	...
	public static final String EXCHANGE = "booking-management-exchange";

	public static final String POST_QUEUE = "booking-management-post-queue";
	public static final String PUT_QUEUE = "booking-management-put-queue";
	public static final String DELETE_QUEUE = "booking-management-delete-queue";

	public static final String POST_ROUTING_KEY = "booking-management-post-routingKey";
	public static final String PUT_ROUTING_KEY = "booking-management-put-routingKey";
	public static final String DELETE_ROUTING_KEY = "booking-management-delete-routingKey";
