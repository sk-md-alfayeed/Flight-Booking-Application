...
public class RabbitMQConfig {
	...
	public static final String EXCHANGE = "checkin-management-exchange";

	public static final String POST_QUEUE = "checkin-management-post-queue";
	public static final String PUT_QUEUE = "checkin-management-put-queue";
	public static final String DELETE_QUEUE = "checkin-management-delete-queue";

	public static final String POST_ROUTING_KEY = "checkin-management-post-routingKey";
	public static final String PUT_ROUTING_KEY = "checkin-management-put-routingKey";
	public static final String DELETE_ROUTING_KEY = "checkin-management-delete-routingKey";
