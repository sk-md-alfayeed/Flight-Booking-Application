...
public class RabbitMQConfig {
	...
	public static final String EXCHANGE = "flight-management-exchange";

	public static final String POST_QUEUE = "flight-management-post-queue";
	public static final String PUT_QUEUE = "flight-management-put-queue";
	public static final String DELETE_QUEUE = "flight-management-delete-queue";

	public static final String POST_ROUTING_KEY = "flight-management-post-routingKey";
	public static final String PUT_ROUTING_KEY = "flight-management-put-routingKey";
	public static final String DELETE_ROUTING_KEY = "flight-management-delete-routingKey";
